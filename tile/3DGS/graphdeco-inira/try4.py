...
viewmatrix[2, 3] = -3.0  # move camera back

projmatrix = getProjectionMatrix(0.01, 100.0, fovx, fovy).cuda()
projmatrix = viewmatrix.unsqueeze(0).bmm(projmatrix.unsqueeze(0)).squeeze(0)

cam_pos = torch.tensor([0.0, 0.0, 3.0], device="cuda")
